...
export default function Home() {
  ...
  return (
    <>
      ...
      <FloatingCTA href="https://github.com/kekyra007-ux/multilingual-nextjs-template" label="View on GitHub" />

      <main>
        <Hero />
        <Banner image="/welcome-banner.png" priority imgTitle="AppTemplate Homepage" alt="AppTemplate Template">
          <></>
        </Banner>
        <AboutSection />
        <FeaturedItems t={t} />
