...
export default function Features() {
  ...
  const ogImage = `${canonicalUrl.replace(/\/$/, "")}/og/features-apptemplate.jpg`;

  if (!ready) {
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh", backgroundColor: "#3B146F" }}>
        <div style={{ fontSize: "24px", color: "#F5C84C", fontWeight: "bold" }}>Loading...</div>
      </div>
    );
  }
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image:alt" content="AppTemplate Features" />
